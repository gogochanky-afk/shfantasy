...
function initializeSchema() {
  ...
  db.exec(`
    CREATE TABLE IF NOT EXISTS entries (
      ...
      pool_id TEXT NOT NULL,
      username TEXT DEFAULT 'demo_user',
  ...
  // 8. events_hot_streak
  db.exec(`
    CREATE TABLE IF NOT EXISTS events_hot_streak (
      id INTEGER PRIMARY KEY AUTOINCREMENT,
      pool_id TEXT NOT NULL,
  ...
  db.exec(`
    CREATE INDEX IF NOT EXISTS idx_hot_streak_active 
    ON events_hot_streak(pool_id, player_id, end_at)
  `);

  // 9. player_stats (demo boxscore)
  db.exec(`
